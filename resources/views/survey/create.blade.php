        ...
        <form action="/survey" method="post">
            ...
            <ol>
                ...
                <li>What is your education level?
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="education_level" id="education_level1" value="5">
                        <label class="form-check-label" for="education_level1">
                            Secondary school and below
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="education_level" id="education_level2" value="6">
                        <label class="form-check-label" for="education_level2">
                            Diploma
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="education_level" id="education_level3" value="7">
                        <label class="form-check-label" for="education_level3">
                            Degree
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="education_level" id="education_level4" value="8">
                ...
                <li>What is your monthly income?
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="monthly_income" id="monthly_income1" value="9">
                        <label class="form-check-label" for="monthly_income1">
                            Less than RM 1000
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="monthly_income" id="monthly_income2" value="10">
                        <label class="form-check-label" for="monthly_income2">
                            Between RM1000 to RM3000
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="monthly_income" id="monthly_income3" value="11">
                        <label class="form-check-label" for="monthly_income3">
                            Between RM3000 to RM5000
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="monthly_income" id="monthly_income4" value="12">
